...
| [`gen_ai.execution.steps`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | any | The ordered execution steps reported by the model or agent provider. [29] | [<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"type": "text",<br>&nbsp;&nbsp;&nbsp;&nbsp;"content": "Weather in Paris?"<br>&nbsp;&nbsp;},<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"type": "reasoning",<br>&nbsp;&nbsp;&nbsp;&nbsp;"content": "The user needs current weather, so I should call the weather tool."<br>&nbsp;&nbsp;},<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"type": "tool_call",<br>&nbsp;&nbsp;&nbsp;&nbsp;"id": "call_VSPygqKTWdrhaFErNvMV18Yl",<br>&nbsp;&nbsp;&nbsp;&nbsp;"name": "get_weather",<br>&nbsp;&nbsp;&nbsp;&nbsp;"arguments": {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"location": "Paris"<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;},<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"type": "tool_call_response",<br>&nbsp;&nbsp;&nbsp;&nbsp;"id": "call_VSPygqKTWdrhaFErNvMV18Yl",<br>&nbsp;&nbsp;&nbsp;&nbsp;"response": "rainy, 57°F"<br>&nbsp;&nbsp;},<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"type": "text",<br>&nbsp;&nbsp;&nbsp;&nbsp;"content": "The weather in Paris is rainy and 57°F."<br>&nbsp;&nbsp;}<br>] |
...
**[29] `gen_ai.execution.steps`:** Execution steps capture provider-reported intermediate work, such as model
reasoning, provider-side tool calls and results, and final model output.
Each step MUST use a part from the `gen_ai.input.messages` and
`gen_ai.output.messages` part schema. Steps MUST be recorded in the order
returned by the provider.

Instrumentations SHOULD populate this attribute when the provider returns
execution steps without start or end timestamps. Instrumentations SHOULD NOT
create spans from steps that do not represent timed operations.

Client-executed tool steps MAY be correlated with `execute_tool` spans by
using matching tool call identifiers in `tool_call` and `tool_call_response`
parts. Provider-executed tools SHOULD use `server_tool_call` and
`server_tool_call_response` parts.
...
Instrumentations MUST follow [JSON schema](/model/gen-ai/gen-ai-execution-steps.json).
...
| [`gen_ai.execution.steps`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | any | The ordered execution steps reported by the model or agent provider. [12] | [<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"type": "text",<br>&nbsp;&nbsp;&nbsp;&nbsp;"content": "Weather in Paris?"<br>&nbsp;&nbsp;},<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"type": "reasoning",<br>&nbsp;&nbsp;&nbsp;&nbsp;"content": "The user needs current weather, so I should call the weather tool."<br>&nbsp;&nbsp;},<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"type": "tool_call",<br>&nbsp;&nbsp;&nbsp;&nbsp;"id": "call_VSPygqKTWdrhaFErNvMV18Yl",<br>&nbsp;&nbsp;&nbsp;&nbsp;"name": "get_weather",<br>&nbsp;&nbsp;&nbsp;&nbsp;"arguments": {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"location": "Paris"<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;},<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"type": "tool_call_response",<br>&nbsp;&nbsp;&nbsp;&nbsp;"id": "call_VSPygqKTWdrhaFErNvMV18Yl",<br>&nbsp;&nbsp;&nbsp;&nbsp;"response": "rainy, 57°F"<br>&nbsp;&nbsp;},<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"type": "text",<br>&nbsp;&nbsp;&nbsp;&nbsp;"content": "The weather in Paris is rainy and 57°F."<br>&nbsp;&nbsp;}<br>] |
...
**[12] `gen_ai.execution.steps`:** Execution steps capture provider-reported intermediate work, such as model
reasoning, provider-side tool calls and results, and final model output.
Each step MUST use a part from the `gen_ai.input.messages` and
`gen_ai.output.messages` part schema. Steps MUST be recorded in the order
returned by the provider.
